      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            type="text"
            maxlength="80"
            placeholder="e.g. Bolt Pistol, Chainsword"
            class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-amber-400"
          />
        </div>
        ...
        <div class="flex flex-wrap gap-x-6 gap-y-3">
          <label class="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" v-model="champion" class="accent-amber-400 rounded" />
            <span class="text-sm text-gray-300">Champion</span>
          </label>
          <label class="flex items-center gap-2 cursor-pointer">
